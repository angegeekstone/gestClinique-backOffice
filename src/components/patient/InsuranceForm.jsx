...
export default function InsuranceForm({ patientData, setPatientData, errors = {} }) {
  ...
  // Calcul automatique de la simulation
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="number"
                min="0"
                value={patientData.insurance.annualLimit || ''}
                onChange={(e) => handleInsuranceChange('annualLimit', parseInt(e.target.value) || 0)}
                placeholder="Ex: 500000"
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.insurance?.annualLimit ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
              />
              {errors.insurance?.annualLimit && (
                <p className="text-sm text-red-600 mt-1">{errors.insurance.annualLimit}</p>
              )}
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Montant à la charge du patient avant prise en charge
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div className="text-center">
                <p className="text-gray-600 font-medium">Plafond restant</p>
                <p className="text-lg font-bold text-gray-700">
                  {(patientData.insurance.annualLimit || 0).toLocaleString()} FCFA
                </p>
            ...
            <div className="flex items-start">
              ...
              <div className="text-sm text-amber-800">
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Le calcul de prise en charge se base sur ces informations</li>
                </ul>
              </div>
            </div>
          </div>
